...
- [ ]  입력 담당 객체
- [ ]  출력 담당 객체
- [ ]  수식에서 커스텀 구분자를 추출하는 기능
- [ ]  구분자를 통해 수식에서 정수를 분리하는 기능
- [ ]  정수들을 모두 더하는 기능
...
- [ ]  입력으로 받은 정수들 중 int 범위를 벗어나는 값이 있는 경우
- [ ]  정수들 사이에 구분자가 아닌 공백을 포함한 문자가 포함된 경우
- [ ]  정수들의 합이 int 범위를 벗어나는 경우
